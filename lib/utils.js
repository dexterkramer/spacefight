...
function stopDragPlayer(sprite)
{
    ...
    if(sprite.ref.overlapedCase !== null)
    {
        ...
        if(sprite.ref.overlapedCase.squad == null)
        {
            ...
            console.log(sprite.ref.overlapedCase.phaserObject.middleY);
...
/*
    ...
    for(i = 0; i < 3; i++)
    {
        ...
        graphicsBorder.lineStyle(10, 0xFF0000, 0.8);
        graphicsBorder.moveTo(startx-5,starty);
        graphicsBorder.lineTo(startx+61,starty-40);
        graphicsBorder.lineTo(startx+127,starty);
        graphicsBorder.lineTo(startx + 127,starty+73);
        graphicsBorder.lineTo(startx + 61,starty+110);
        graphicsBorder.lineTo(startx-5,starty+73);
        graphicsBorder.lineTo(startx-5,starty);
